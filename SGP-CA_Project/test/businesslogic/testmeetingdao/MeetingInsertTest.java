...
public class MeetingInsertTest {
    ...
    public void testCorrectMeetingInsert(){
        meeting = new Meeting(0,"2021-12-15", "17:00:00", "Plan de Estudios de ISOF", "2021-04-30", "Realizada", "Teams", "Segundo ejemplo de prueba", "1. Se necesita un plan de trabajo", "1. Realizar plan de trabajo", "MARE980608CDF");
...
//        meeting.getAssistantsRol().add(new AssistantRol(0, "Estefanía Berenice Martínez Ramírez", "Tomador de tiempo",2, "EBMR"));
        ...
        Meeting meetingRetrieved = meeting;
